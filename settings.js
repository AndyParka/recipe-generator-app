class SettingsManager {
    ...
    async testApiKey() {
        ...
        this.updateApiStatus('Testing API connection...', 'info');
        ...
        try {
            ...
            if (response.ok) {
                ...
                this.updateApiStatus('✅ API connection successful', 'success');
            } else {
            ...
            this.updateApiStatus('❌ API connection failed: ' + error.message, 'error');
        }
    }
